          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <div
                  className={`absolute right-8 top-9 min-w-[200px] z-50 ${isOpen ? "block" : "hidden"} my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm bg-neutral-primary-medium border border-default-medium rounded-base w-44`}
                  id="dropdown-user"
                >
                  <div
